...
rangesA = [4.38 1.425 3.96 2.46 3.3 3.09 3.57 3.06 4.395 4.23 3.18 2.655 3.3 2.415 3.255 4.29 3.87 3.33 3.945 2.82 3.015 5.325 3.42];
rangesB = [5.22 4.2 4.29 3.3 5.04 5.745 3.96 4.035 5.55 5.31 4.38 4.965 3.3 3.66 3.585 6.33 4.92 3.495 4.8 3.27 4.26 5.7 3.6];
posInterval = 9; % acutal position interval in inches
centerIndex = 12; % index of actual center position (closest to radar)
