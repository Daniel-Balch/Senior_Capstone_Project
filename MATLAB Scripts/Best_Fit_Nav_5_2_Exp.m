...
rangesA = [2.4 2.37 2.34 2.25 2.22 2.31 2.34 2.34 2.34 2.46 2.4];
rangesB = [2.4 2.37 2.34 2.25 2.22 2.31 2.34 2.34 2.34 2.46 2.4];
posInterval = 6; % acutal position interval in inches
centerIndex = 6; % index of actual center position (closest to radar)
